(function () {
     ...
     */
    module.exports.pass = function (args, bind) {
        var self = this;
     ...
     * @return {Function} closure
     */
    module.exports.prepend = function (args, bind) {
        var self = this,
            max = args.length;
     ...
     * @return {Function} closure
     */
    module.exports.append = function (args, bind) {
        var self = this,
            max = args.length;
     ...
     */
    module.exports.delay =function (delay_ms, bind, args) {
     ...
     */
    module.exports.periodical = function (periodical_ms, bind, args) {
     ...
     * @param {Array} args The arguments passed
     */
    module.exports.debounce = function (wait_ms, args, bind) {
        var timeout,
            self = this;
     ...
     * @param {Array} args The arguments passed
     */
    module.exports.throttle = function (wait_ms, bind, args) {
        var timeout,
            throttling,
            more,
     ...
     */
    module.exports.once = function (bind, args) {
        var first = false,
            memo,
            self = this;
