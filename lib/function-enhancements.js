(function () {
    ...
    defineProperty(Function.prototype, "append", {
         ...
         * Returns a closure with the given arguments before the ones you send at the call
         *
         * @param {Array} args Array or null
         * @param {Mixed} bind
         * @return {Function} closure
         */
        value: function (args, bind) {
    ...
    defineProperty(Function.prototype, "every", {
         ...
         */
        value: function (ntimes, max_executions) {
            var attempts = 0,
                calls = 0,
                self = this;
    ...
    defineProperty(Function.prototype, "nth", {
         ...
         */
        value: function (ntimes, delay, first_delay, bind, args, last_func) {
            var self = this,
                outputs = [],
                interval;
    ...
    defineProperty(Function.prototype, "funnel", {
         ...
         */
        value: function (max, args, bind, where) {
            where = where || "append";
            ...
            return function () {
                ...
                ++in_execution;
                self.apply(args || arguments, bind || self);
    ...
    defineProperty(Function.prototype, "single", {
         ...
         * @param {String} where append or prepend, where the callback will be.
         */
        value: function (args, bind, where) {
            return this.funnel(1, args, bind, where);
        },
        writable : false,
        enumerable : false,
        configurable : false
